...
def stereoCalibrateCamera(camera_c1, camera_c2,camera_name,chessboard_box_size=1,chessboard_grid_size=(10,7),number_of_frames=50):
    ...
    print("체스보드가 검출된 이미지 쌍 개수:", len(twodpoints_c1), len(twodpoints_c2), len(threedpoints))
